...
export default function WaitlistSection() {
  ...
  return (
    <section id="waitlist" data-testid="waitlist-section" className="relative py-24 sm:py-32">
      {/* Subtle glow */}
      ...
      <div className="relative z-10 max-w-xl mx-auto px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-[#A3A3A3] text-sm sm:text-base leading-relaxed mb-10">
        ...
        >
          {/* Role toggle */}
          <Tabs value={role} onValueChange={setRole} data-testid="waitlist-role-toggle">
