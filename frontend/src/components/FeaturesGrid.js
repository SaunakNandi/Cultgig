...
const features = [
  {
    ...
    hasBgImage: true,
    bgImage:
      "https://images.pexels.com/photos/33923311/pexels-photo-33923311.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
  },
  {
    icon: CalendarCheck,
    title: "Easy Booking",
  ...
  },
  {
    ...
    hasBgImage: true,
    bgImage:
      "https://images.unsplash.com/photo-1680946496238-5272d3c407fc?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA1MTN8MHwxfHNlYXJjaHwzfHxkYXJrJTIwcmVzdGF1cmFudCUyMGludGVyaW9yfGVufDB8fHx8MTc3NDc2MzcyNHww&ixlib=rb-4.1.0&q=85",
  },
  {
    icon: MessageCircle,
